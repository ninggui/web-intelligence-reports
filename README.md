...
**用web_search搜集情报→验证→生成结构化报告→发布飞书文档。触发：舆情监控、品牌分析、行业报告、竞品调研。**

[SkillHub 在线安装](https://skillhub.cn/skills/web-intelligence-reports) · [快速使用](#快速使用) · [核心能力](#核心能力) · [使用边界](#使用边界)
...
```text
使用 web-intelligence-reports 技能。
这是待处理内容，直接执行。
```
...
- 涉及「web-intelligence-reports」的场景任务
- 需要复用已验证方法论的工作
- 批量/复杂任务中的专项环节
